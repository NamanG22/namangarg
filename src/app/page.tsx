  ...
  return (
    <>
      ...
      <div ref={containerRef} className='min-h-[500vh] relative'> 
        ...
        {/* First Section */}
        <motion.div 
          className='h-screen w-screen fixed top-0 flex items-center justify-left px-28'
          style={{
        ...
        >
          ...
          >
            <div className="flex flex-col">
              <p className={`text-xl roboto-mono text-gray-400`}>
                nova {'%_'} HashMap{'<'}<span className="text-red-600">String</span>, <span className="text-red-600">String</span>{'>'} <span className="text-white text-6xl">education</span> = <span className="text-blue-600">new</span> HashMap();
              </p>
        ...
        <motion.div className='flex space-x-4 items-center justify-between' style={{
          ...
          <div className='w-2/3'>
            <div className="flex flex-col">
              <p className="text-2xl roboto-mono">
              ...
              <div className="ml-8 mt-4 space-y-2">
                <p className="text-xl roboto-mono">
                ...
                <p className="text-xl roboto-mono mt-4">
                ...
                <div className="ml-8">
                  <p className="text-xl roboto-mono text-gray-400">...</p>
                </div>
                <p className="text-xl roboto-mono text-gray-400">{'}'}</p>
              </div>
              <p className="text-xl roboto-mono text-gray-400">{'}'}</p>
              <p className="text-xl roboto-mono mt-2">
          ...
          <div className="flex flex-col w-1/3 bg-black rounded-lg h-fit">
